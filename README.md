...
fork from [howardEagle/yii2-inline-widgets-behavior](https://github.com/howardEagle/yii2-inline-widgets-behavior)
Install
------------

Either run
~~~
$ php composer.phar require --prefer-dist lesha724/Yii2-inline-widgets-behavior "*"
~~~
or add
~~~~
"lesha724/Yii2-inline-widgets-behavior": "*"
~~~
...
```php
use lesha724\behaviors\InlineWidgetsBehavior;
